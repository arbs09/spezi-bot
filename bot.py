...
async def on_message(message):
    ...
    if ("kann ich eine spezi" in message_content or "gibst du mir eine spezi" in message_content or "Ich will ne spezi" in message_contentor "Ich will spezi" in message_content):
